...
function Show-ToastNotification {
    ...
    if (Get-Module -ListAvailable -Name BurntToast) {
        New-BurntToastNotification -Text $Title, $Message -AppLogo "C:\Windows\System32\securityandmaintenance.png"
        return
    }
...
try {
    ...
    Write-EventLogError $_.Exception.Message
    exit 1
}
"@ | Out-File -FilePath "$TOOLS_DIR\verify.ps1" -Encoding UTF8
```
